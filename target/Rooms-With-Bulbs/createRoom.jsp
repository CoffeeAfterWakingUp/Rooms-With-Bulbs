        ...
        <div>
            <form action="">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control text-white" name="roomName" id="roomName"
                ...
                <div class="mb-3">
                    ...
                    <select name="country" id="country" class="form-select text-white"
                            style="background-color: transparent">
                        <c:forEach var="c" items="${requestScope.countryList}">
                            <option style="background-color: transparent" value="${c.id}">${c.name}</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="form-check form-switch mb-3">
                    ...
                    <label class="form-check-label" for="createBulb"><i class="fa fa-lightbulb-o"
                                                                        id="createLightbulbIcon"
